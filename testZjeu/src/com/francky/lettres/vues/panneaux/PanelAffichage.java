...
public class PanelAffichage extends JPanel {
	...
	/*
	 * indication du mot trouv� pour le panel affichage
	 */
	private boolean motTrouve = false;		//lorsque le mot est trouv�, l'affichage de congratulation par paintComponent
	...
	/*
	 * Taille et position du mot � chercher
	 */
	...
	public void paintComponent(Graphics g) {
		...
		if(showText && motTrouve){
			...
			//je ne sais pas pourqupi il a fallu diviser le g.getFontMetrics().getHeight() par 3 ... je m'attendais plut�t � diviser par 2 mais ca passe mieux avec 3
	...
	public synchronized void panelAffichFelicit(int time) {
		final int showTextTimer = ++showTextCall; // �a c'est juste pour si on rappelle showText alors qu'il y a un texte d�j� affich�
	...
	public synchronized void hideText() {
		if ( showText ) {
			...
			//r�z du nombre de lettres trouv�es et utilis�es
