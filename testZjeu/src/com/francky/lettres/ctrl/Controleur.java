	...
	public void searchLetter(String lettreClic) {
		...
		StringBuilder strBdMotTemp = new StringBuilder();
			...
			for(int rank = 0; rank < strMot.length(); rank++){
				// il faut adapter les lettres du mot avec les lettres sans accents, que ce soit les accents français ou vietnamiens
				if(("" + strMot.charAt(rank)).equals("é") || ("" + strMot.charAt(rank)).equals("è") || ("" + strMot.charAt(rank)).equals("ê") || ("" + strMot.charAt(rank)).equals("ẹ")
						 || ("" + strMot.charAt(rank)).equals("ẻ") || ("" + strMot.charAt(rank)).equals("ẽ") || ("" + strMot.charAt(rank)).equals("ế") || ("" + strMot.charAt(rank)).equals("ề")
						 || ("" + strMot.charAt(rank)).equals("ể") || ("" + strMot.charAt(rank)).equals("ễ") || ("" + strMot.charAt(rank)).equals("ệ")){
					strBdMotTemp.append("e");
				} else if(("" + strMot.charAt(rank)).equals("à") || ("" + strMot.charAt(rank)).equals("á") || ("" + strMot.charAt(rank)).equals("â") || ("" + strMot.charAt(rank)).equals("ã")
						 || ("" + strMot.charAt(rank)).equals("ạ") || ("" + strMot.charAt(rank)).equals("ả") || ("" + strMot.charAt(rank)).equals("ấ") || ("" + strMot.charAt(rank)).equals("ầ")
						 || ("" + strMot.charAt(rank)).equals("ẩ") || ("" + strMot.charAt(rank)).equals("ẫ") || ("" + strMot.charAt(rank)).equals("ậ") || ("" + strMot.charAt(rank)).equals("ắ")
						 || ("" + strMot.charAt(rank)).equals("ằ") || ("" + strMot.charAt(rank)).equals("ẳ") || ("" + strMot.charAt(rank)).equals("ẵ") || ("" + strMot.charAt(rank)).equals("ặ")){
					strBdMotTemp.append("a");
				} else if(("" + strMot.charAt(rank)).equals("ự") || ("" + strMot.charAt(rank)).equals("ữ") || ("" + strMot.charAt(rank)).equals("ữ") || ("" + strMot.charAt(rank)).equals("ử")
						 || ("" + strMot.charAt(rank)).equals("ừ") || ("" + strMot.charAt(rank)).equals("ứ") || ("" + strMot.charAt(rank)).equals("ủ") || ("" + strMot.charAt(rank)).equals("ụ")){
					strBdMotTemp.append("u");
				} else if(("" + strMot.charAt(rank)).equals("đ")){
					strBdMotTemp.append("d");
				} else if(("" + strMot.charAt(rank)).equals("ô") || ("" + strMot.charAt(rank)).equals("ọ") || ("" + strMot.charAt(rank)).equals("ỏ") 
									|| ("" + strMot.charAt(rank)).equals("ố") || ("" + strMot.charAt(rank)).equals("ồ") || ("" + strMot.charAt(rank)).equals("ổ")
									|| ("" + strMot.charAt(rank)).equals("ỗ") || ("" + strMot.charAt(rank)).equals("ộ") || ("" + strMot.charAt(rank)).equals("ớ")
									|| ("" + strMot.charAt(rank)).equals("ờ") || ("" + strMot.charAt(rank)).equals("ở") || ("" + strMot.charAt(rank)).equals("ỡ") 
									|| ("" + strMot.charAt(rank)).equals("ợ") || ("" + strMot.charAt(rank)).equals("ò") || ("" + strMot.charAt(rank)).equals("ó")
									|| ("" + strMot.charAt(rank)).equals("õ")){
					strBdMotTemp.append("o");
				} else if(("" + strMot.charAt(rank)).equals("ç")){
					strBdMotTemp.append("c");
				} else if(("" + strMot.charAt(rank)).equals("î") || ("" + strMot.charAt(rank)).equals("ï") || ("" + strMot.charAt(rank)).equals("í") || ("" + strMot.charAt(rank)).equals("ì")
						 || ("" + strMot.charAt(rank)).equals("ỉ") || ("" + strMot.charAt(rank)).equals("ị")){
					strBdMotTemp.append("i");
				} else if(("" + strMot.charAt(rank)).equals("ỹ") || ("" + strMot.charAt(rank)).equals("ỷ") || ("" + strMot.charAt(rank)).equals("ỵ") || ("" + strMot.charAt(rank)).equals("ỳ")){
